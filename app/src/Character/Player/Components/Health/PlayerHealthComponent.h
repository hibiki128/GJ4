...
public:
	...
	/// <summary>
	/// 体力を回復する。回復アイテムのように「拾ったら効く」ものから呼ばれる。
	///
	/// 倒れているときは回復しない。倒れたあとに立ち上がらせるのは蘇生の話で、
	/// 回復とは別物なので、混ぜずにここでは断っている。
	/// 戻り値を返すのは、効かなかったときにアイテムを消さずに残せるようにするため
	/// </summary>
	/// <param name="amount">回復量（0以下なら何もしない）</param>
